...
st.markdown("Welcome to the **Decision Intelligence Platform**. Select a module from the sidebar.")
...
st.info("⚡ This dashboard is powered by an in-memory DuckDB analytical engine, capable of querying millions of Parquet records in milliseconds.")
